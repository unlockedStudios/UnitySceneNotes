...
namespace SceneNotes.Editor
{
    ...
    public static class SceneNoteSettingsProvider
    {
        ...
        private const string SETTINGS_FOLDER = "Assets/SceneNotes/Settings";
        ...
        public static void SaveSettings(SceneNoteSettings settings)
        {
        ...
        private static string SettingsPath => $"{SETTINGS_FOLDER}/{SETTINGS_FILE_NAME}";
    }
}
